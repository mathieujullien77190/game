...
import type { EditorManager } from "@tic-tac-tic/engine/Manager/EditorManager"
import type { LineType } from "@tic-tac-tic/engine/entities/Line/Line"
import type { TransformerType } from "@tic-tac-tic/engine/entities/Transformer/Transformer"
import { CANVAS_H, CANVAS_W, GRID_SIZE } from "@tic-tac-tic/engine/constants"
import { distance } from "@tic-tac-tic/engine/Utils/geometry"
