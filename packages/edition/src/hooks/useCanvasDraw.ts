...
import { InverterEditor } from "@tic-tac-tic/engine/entities/Inverter/InverterEditor"
import { TransformerEditor } from "@tic-tac-tic/engine/entities/Transformer/TransformerEditor"
import type { TransformerType } from "@tic-tac-tic/engine/entities/Transformer/Transformer"
import { ArrivalEditor } from "@tic-tac-tic/engine/entities/Arrival/ArrivalEditor"
import { ScreenGateEditor } from "@tic-tac-tic/engine/entities/ScreenGate/ScreenGateEditor"
import { smoothFps } from "@tic-tac-tic/engine/stats"
import { Canvas2DRenderer } from "@tic-tac-tic/canvas-render"
